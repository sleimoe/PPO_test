            ...
            while not is_terminal:
                ...
                if is_terminal:
                    ...
                    if episode % 25 == 0:
                        ...
                        print("After Episode: " + str(episode) + " Average Score is: " + str(avg_score))
                        #if avg_score >= 1000:
                            #print("Solved!")
                            #render = True
                    episode += 1
...
rospy.init_node('turtlebot2_maze_gym', anonymous=True, log_level=rospy.FATAL)
...
out_model_file_path = os.path.join(models_dir_path, "turtlebot.pkl")

env = gym.make("TurtleBot2Maze-v0")
agent = PPO(env, num_features=6, num_actions=3, gamma=.98, lam=1, epsilon=.2,
...
agent.save(out_model_file_path)
